...
public class MCDialogueManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject speechBubbleChoice1Button;
    [SerializeField] private GameObject speechBubbleChoice2Button;
    ...
    private IEnumerator TypeSpeechBubbleDialogue()
    {
        ...
        speechBubbleChoice1Button.SetActive(true);
        speechBubbleChoice2Button.SetActive(true);

    }

    public void ContinueSpeechBubbleDialogue()
    {
        speechBubbleChoice1Button.SetActive(false);
        speechBubbleChoice2Button.SetActive(false);
        speechBubbleText.text = string.Empty;
